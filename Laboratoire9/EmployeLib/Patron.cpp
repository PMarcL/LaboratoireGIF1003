 ...
 */
Patron::Patron(const std::string& p_nom, const std::string& p_prenom, util::Date p_dateNaissance, int p_codeDepartement,
		double p_salaireHebdo) :
		Employe(p_nom, p_prenom, p_dateNaissance, p_codeDepartement), m_salaireHebdo(p_salaireHebdo) // appelle constructeur de classe de base.
{
