 ...
 */
EmployeCommission::EmployeCommission(const std::string& p_nom, const std::string& p_prenom, util::Date p_dateNaissance,
		int p_codeDepartement, double p_salaire, double p_commission, int p_quantite) :
		Employe(p_nom, p_prenom, p_dateNaissance, p_codeDepartement), m_salaire(p_salaire), m_commission(p_commission), m_quantite(
				p_quantite) {
