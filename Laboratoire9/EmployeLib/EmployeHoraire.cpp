 ...
 */
EmployeHoraire::EmployeHoraire(const std::string& p_nom, const std::string& p_prenom, util::Date p_dateNaissance,
		int p_codeDepartement, double p_tauxHoraire, double p_heures) :
		Employe(p_nom, p_prenom, p_dateNaissance, p_codeDepartement), m_tauxHoraire(p_tauxHoraire), m_heures(p_heures) // appelle du constructeur de la classe de base.
{
