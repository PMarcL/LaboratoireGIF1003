...
public:
	EmployeHoraire(const std::string& p_nom, const std::string& p_prenom, util::Date p_dateNaissance,
			int p_codeDepartement, double p_tauxHoraire = 0.0, double p_heures = 0.0);
