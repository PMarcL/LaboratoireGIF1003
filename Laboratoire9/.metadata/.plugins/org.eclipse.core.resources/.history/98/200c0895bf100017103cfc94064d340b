...
public:
	...
	EmployeCommission(const std::string& p_nom, const std::string& p_prenom, util::Date p_dateNaissance,
			int p_codeDepartement, double p_salaire = 0.0, double p_commission = 0.0, int p_quantite = 0);
